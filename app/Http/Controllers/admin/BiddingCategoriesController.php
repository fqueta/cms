...
class BiddingCategoriesController extends Controller
{
    ...
    public function index(User $user)
    {
        ...
        $title = 'Cadastro de Biddings_categories';
        $titulo = $title;
    ...
    public function create(User $user)
    {
        ...
        $title = 'Cadastrar Biddings_categories';
        $titulo = $title;
        $config = [
            'ac'=>'cad',
    ...
    public function store(Request $request)
    {
        ...
        $validatedData = $request->validate([
            'nome' => ['required','string','unique:biddings_categories'],
        ]);
        $dados = $request->all();
    ...
    public function edit($biddings_categories,User $user)
    {
        ...
        if(!empty($dados)){
            $title = 'Editar cadastro de Biddings_categories';
            $titulo = $title;
            $dados[0]['ac'] = 'alt';
