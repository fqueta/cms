        ...
        $arr = [
            'leis'=>[
                ...
                'config'=>Qlib::lib_array_json([
                    ...
                    'post_content'=>['label'=>'Descrição (opcional)','active'=>false,'type'=>'textarea','exibe_busca'=>'d-block','event'=>'','tam'=>'12','class_div'=>'','class'=>'editor-padrao','placeholder'=>__('Escreva seu conteúdo aqui..')],
